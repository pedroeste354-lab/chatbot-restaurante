...
adminRouter.post('/admin/save', authMiddleware, (req, res) => {
  ...
  const allowed = ['nombre', 'direccion', 'telefono', 'whatsapp', 'horario', 'precio_medio', 'cocina', 'parking', 'terraza', 'google_maps_embed', 'menu_dia', 'carta', 'nosotros', 'anos', 'valoracion', 'num_valoraciones'];
